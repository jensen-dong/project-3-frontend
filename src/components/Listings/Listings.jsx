          ...
          listings.map((listing) => (
            <div key={listing._id} className="card">
              {randomImages[listing._id] ? (
                <img src={randomImages[listing._id]} alt={listing.title} />
              ) : (
                <div
                  style={{
                    width: "200px",
              ...
              <Link className="button" to={`/reviews/new/${listing._id}`}> Add Review</Link>
              <Link className="button" to={`/reviews/find/${listing._id}`}> View Reviews</Link>
            </div>
          ))
        ) : (
